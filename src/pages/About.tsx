      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-16 flex flex-col items-center gap-4 text-center">
          <div className="inline-flex items-center gap-3 rounded-full border border-[#1CA6A3]/20 bg-[#1CA6A3]/10 px-5 py-2">
            <span className="h-[1.5px] w-5 bg-[#1CA6A3]" />
            <span className="text-[11px] font-medium uppercase tracking-[.15em] text-[#0d7a77]">
              EITI — Detroit
            </span>
            <span className="h-[1.5px] w-5 bg-[#1CA6A3]" />
          </div>
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-[#111] sm:text-5xl">
            Built on <span className="text-[#1CA6A3]">purpose</span>,<br />
            driven by people
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div className="group cursor-default overflow-hidden rounded-[20px] border border-black/[0.06] bg-white transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_60px_rgba(0,0,0,0.09)]">
            <div className="relative p-9">
              ...
              <p className="mt-3.5 text-[14.5px] font-light leading-[1.78] text-[#555]">
                EITI trains Detroit residents for real careers through hands-on, employer-aligned
                programs — equipping individuals with the skills and credentials needed for
                sustainable employment and long-term stability.
              </p>
            </div>
            <div className="flex items-center gap-2.5 border-t border-black/[0.06] px-9 py-5">
              ...
              <ArrowRight size={16} stroke="#1CA6A3" strokeWidth={2} className="ml-auto" />
            </div>
          </div>
          ...
          <div className="group cursor-default overflow-hidden rounded-[20px] border border-black/[0.06] bg-white transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_60px_rgba(0,0,0,0.09)]">
            <div className="relative p-9">
              ...
              <p className="mt-3.5 text-[14.5px] font-light leading-[1.78] text-[#555]">
                To build a stronger, more inclusive workforce connecting every individual to real
                opportunity, long-term careers, and lasting economic stability — where communities
            ...
            <div className="flex items-center gap-2.5 border-t border-black/[0.06] px-9 py-5">
              ...
              <ArrowRight size={16} stroke="#74B4E0" strokeWidth={2} className="ml-auto" />
            </div>
          </div>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10 text-center">
          ...
          <h2 className=" text-5xl font-semibold leading-[1.05] tracking-tight text-[#111] sm:text-6xl">
            Meet the <em className="text-[#1CA6A3]">hearts</em>
            <br />behind EITI
          </h2>
          <p className="mx-auto mt-5 max-w-md text-[15px] font-light leading-[1.8] text-[#777]">
            Each member of our team has chosen this work not for ease — but because they
            believe every person deserves a real chance.
          </p>
        </div>
        ...
        {/* Footer line */}
        <div className="mt-20 flex items-center justify-center gap-5 text-[12px] font-light uppercase tracking-[.12em] text-[#bbb]">
          <span className="h-px w-16 bg-gradient-to-r from-transparent to-[#ccc]" />
          United by purpose
          <span className="h-px w-16 bg-gradient-to-l from-transparent to-[#ccc]" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-4   bg-white/5 border border-white/10">
              <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#1CA6A3]">Our Impact</span>
            </div>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-headline font-bold text-white leading-tight mb-8">
              Building <span className="text-[#1CA6A3]">Careers</span>,<br className="hidden sm:block" />
              <span className="text-[#74B4E0]">Transforming</span> Communities
            </h2>
            <div className="h-1 w-24 mx-auto bg-gradient-to-r from-[#1CA6A3] via-[#74B4E0] to-[#5FB673] rounded-full" />
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              <p className="text-lg sm:text-xl text-white/70 leading-relaxed mb-10 max-w-lg">
                EITI is more than a training institute. We are a bridge between potential and opportunity, connecting Detroit residents to meaningful careers.
              </p>

              <div className="space-y-6">
                {[
                  { icon: "handshake", text: "Employer-aligned training programs", color: "#1CA6A3" },
                  { icon: "construction", text: "Hands-on, practical skill development", color: "#74B4E0" },
                  { icon: "trending_up", text: "Proven pathway to economic mobility", color: "#5FB673" },
                  { icon: "groups", text: "Community-focused workforce solutions", color: "#1CA6A3" }
                ].map((item, i) => (
                  <div
                    key={i}
                  ...
                  >
                    ...
                    <div className="pt-1">
                      <span className="text-white/90 font-medium text-base">{item.text}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="order-1 lg:order-2 relative">
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/20">
                    <div className="flex items-center gap-4 sm:gap-8">
                      <div className="text-center">
                        <div className="text-2xl sm:text-3xl font-headline font-bold text-[#1CA6A3]">94%</div>
                        <div className="text-[10px] sm:text-xs text-white/60 uppercase tracking-wider">Placement</div>
                      </div>
                      <div className="w-px h-10 bg-white/20" />
                      <div className="text-center">
                        <div className="text-2xl sm:text-3xl font-headline font-bold text-[#74B4E0]">12k+</div>
                        <div className="text-[10px] sm:text-xs text-white/60 uppercase tracking-wider">Graduates</div>
                      </div>
                      <div className="w-px h-10 bg-white/20" />
                      <div className="text-center">
                        <div className="text-2xl sm:text-3xl font-headline font-bold text-[#5FB673]">15+</div>
                        <div className="text-[10px] sm:text-xs text-white/60 uppercase tracking-wider">Years</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute -bottom-8 -left-8 w-32 sm:w-48 z-20 hidden sm:block">
                <div className="rounded-xl overflow-hidden shadow-xl border-2 border-white/10">
                  <img
