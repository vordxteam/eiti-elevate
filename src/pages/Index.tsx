...
const WhatWeDoSection = () => {
  const cards = [
    ...
    },
    {
      ...
      description:
        "EITI provides hands on training, certified skills, and career pathways for Metro Detroit’s high-demand industries.",
      accent: "#74B4E0",
    },
    {
      number: "03",
...
const HomePage = () => (
  <div>
    <PageHero
      ...
      description="EITI prepares Metro Detroit residents for real careers through hands-on training and direct pathways to employment."
