        ...
        <div className="container-narrow grid md:grid-cols-12 gap-12 items-center relative z-10 w-full">
          <div className="md:col-span-7">
            ...
            <h1 className="headline-lg font-headline text-primary leading-[1.1] tracking-tight mb-8">
              Building Careers in <span className="text-tertiary">Emerging</span> Industries.
            </h1>
            <p className="text-lg md:text-xl text-on-surface-variant max-w-xl mb-10 leading-relaxed">
              The future of work isn't coming—it's here. EITI provides the technical mastery and industrial wisdom to lead in the world's most vital growing sectors.
            </p>
          ...
          <div className="md:col-span-5 relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-primary text-on-primary p-6 rounded-xl editorial-shadow max-w-[200px]">
      ...
      <div className="container-narrow">
        <div className="flex flex-col md:flex-row gap-16 items-start">
          <div className="md:w-1/3">
            <h2 className="text-sm font-bold text-tertiary uppercase tracking-[0.2em] mb-4">Our Mission</h2>
          ...
          <div className="md:w-2/3">
            <p className="text-xl text-on-surface-variant leading-relaxed mb-8">
              At Emerging Industries Training Institute, we don't just teach skills; we forge careers. By bridging the gap between traditional labor and high-growth technology sectors, we empower the next generation of industrial leaders.
            </p>
            <div className="grid grid-cols-2 gap-8">
              <div>
                <div className="text-primary font-bold mb-2 flex items-center gap-2">
                  <span className="material-symbols-outlined text-tertiary">check_circle</span> Industry Alignment
                </div>
                <p className="text-sm text-on-surface-variant">Curriculums developed alongside Detroit's leading industrial partners.</p>
              </div>
              <div>
                <div className="text-primary font-bold mb-2 flex items-center gap-2">
                  <span className="material-symbols-outlined text-tertiary">check_circle</span> Hands-on Focus
                </div>
                <p className="text-sm text-on-surface-variant">80% of our training takes place in live laboratory environments.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container-narrow">
          <div className="grid md:grid-cols-4 gap-12 text-on-primary">
            <div className="text-center">
              <div className="headline-lg font-black text-on-primary mb-4">1,200+</div>
            ...
            <div className="text-center">
              <div className="headline-lg font-black text-on-primary mb-4">94%</div>
              <div className="w-full bg-white/20 h-1 rounded-full mb-2">
                <div className="bg-tertiary-fixed-dim h-full rounded-full w-11/12"></div>
              </div>
              <div className="text-sm font-semibold opacity-70">Placement Rate</div>
            </div>
            <div className="text-center">
              <div className="headline-lg font-black text-on-primary mb-4">$18M+</div>
              <div className="w-full bg-white/20 h-1 rounded-full mb-2">
                <div className="bg-tertiary-fixed-dim h-full rounded-full w-2/3"></div>
              </div>
              <div className="text-sm font-semibold opacity-70">Economic Impact</div>
            </div>
            <div className="text-center">
              <div className="headline-lg font-black text-on-primary mb-4">150+</div>
              <div className="w-full bg-white/20 h-1 rounded-full mb-2">
                <div className="bg-tertiary-fixed-dim h-full rounded-full w-1/2"></div>
              </div>
              <div className="text-sm font-semibold opacity-70">Partner Companies</div>
            </div>
          </div>
        </div>
      </FluidReveal>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-12">
                <div className="relative pl-12 border-l-4 border-primary-container">
                  <p className="text-xl italic text-on-surface-variant mb-6">
                    "EITI gave me more than just technical skills; they gave me a roadmap for professional life. I went from having a job to having a career in sustainable energy."
                  </p>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-primary">Marcus Thompson</div>
                      <div className="text-xs text-on-surface-variant">Solar PV Technician, Class of '22</div>
                    </div>
                  </div>
                </div>
                <div className="relative pl-12 border-l-4 border-secondary-container">
                  <p className="text-xl italic text-on-surface-variant mb-6">
                    "The hands-on training at EITI prepared me for real-world challenges. My carpentry skills got me a job immediately, and now I'm leading projects worth over $500K."
                  </p>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-primary">Aisha Johnson</div>
                      <div className="text-xs text-on-surface-variant">Master Carpenter, Class of '23</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <div className="pt-12">
                  <img alt="Training" className="rounded-xl editorial-shadow mb-4 w-full aspect-[3/4] object-cover" src={projectPark} />
                  <img alt="Graduation" className="rounded-xl editorial-shadow w-full aspect-square object-cover" src={projectBuffalo} />
                </div>
                <div>
                  <img alt="Instruction" className="rounded-xl editorial-shadow mb-4 w-full aspect-square object-cover" src={heroImage} />
                  <img alt="Career" className="rounded-xl editorial-shadow w-full aspect-[3/4] object-cover" src={projectPark} />
                </div>
              </div>
            </div>
          </div>
    ...
    <section className="section-padding bg-surface-container-low">
      <div className="container-narrow">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-headline font-bold text-primary mb-4">Real-World Projects & Impact</h2>
          <p className="text-on-surface-variant max-w-2xl mx-auto">
            See how our training translates to tangible community impact through hands-on project work.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-8">
          {/* Virginia Park Beautification */}
          <Link to="/work/virginia-park" className="group relative overflow-hidden rounded-xl bg-surface-container-lowest editorial-shadow">
            <div className="aspect-[4/3] overflow-hidden">
              <img alt="Virginia Park Beautification Project" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src={projectPark} />
            </div>
            <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-transparent to-transparent flex flex-col justify-end p-8 text-white">
              <span className="inline-block px-3 py-1 rounded-lg bg-white/90 backdrop-blur text-primary text-xs font-bold tracking-wide uppercase mb-3 max-w-fit">Urban Renewal</span>
              <h4 className="text-2xl font-headline font-bold mb-2">Virginia Park Beautification</h4>
              <p className="text-sm opacity-90 mb-4">Comprehensive landscaping and community green-space restoration project.</p>
          ...
          <Link to="/work/buffalo-soldiers" className="group relative overflow-hidden rounded-xl bg-surface-container-lowest editorial-shadow">
            <div className="aspect-[4/3] overflow-hidden">
              <img alt="Buffalo Soldiers Monument Project" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src={projectBuffalo} />
            </div>
            <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-transparent to-transparent flex flex-col justify-end p-8 text-white">
              <span className="inline-block px-3 py-1 rounded-lg bg-white/90 backdrop-blur text-primary text-xs font-bold tracking-wide uppercase mb-3 max-w-fit">Historic Preservation</span>
              <h4 className="text-2xl font-headline font-bold mb-2">Buffalo Soldiers Project</h4>
              <p className="text-sm opacity-90 mb-4">Restoration of heritage monuments honoring African American military history.</p>
              <div className="flex items-center gap-2 text-xs opacity-80">
                <span className="material-symbols-outlined text-sm">location_on</span>
                Detroit, MI
              </div>
    ...
    <section className="section-padding bg-surface">
      <div className="container-narrow">
        <div className="text-center mb-12">
          <p className="text-sm font-bold text-outline uppercase tracking-widest mb-8">Our Industry Partners</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-5 gap-12 items-center justify-items-center">
          {["General Motors", "DTE Energy", "Detroit Public Schools", "UAW Local 22", "City of Detroit", "Ford Motor Company", "Blue Cross Blue Shield"].slice(0, 5).map((name) => (
        ...
        <div className="bg-primary-container rounded-2xl p-12 md:p-20 text-center relative overflow-hidden editorial-shadow">
          <div className="relative z-10">
            <h2 className="text-4xl md:text-5xl font-headline font-extrabold text-white mb-6 leading-tight">
              Your Future in Industry <br className="hidden md:block" /> Starts Today.
            </h2>
            <p className="text-on-primary-container/80 text-lg mb-10 max-w-xl mx-auto">
              Applications for our Fall cohort are now open. Secure your place in the next generation of technical experts.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/apply"
                className="bg-tertiary-container text-on-tertiary-container px-10 py-4 rounded-xl font-bold text-lg inner-glow hover:opacity-90 transition-all text-center"
              >
                Apply Now
              </Link>
              <Link
                to="/about"
                className="bg-white/10 text-white backdrop-blur-md px-10 py-4 rounded-xl font-bold text-lg hover:bg-white/20 transition-all text-center"
              >
                Speak to an Advisor
              </Link>
            </div>
