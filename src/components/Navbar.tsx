...
const Navbar = () => {
  ...
  return (
    ...
    <>
      ...
      <nav className={`fixed top-0   w-full z-50 transition-all duration-300 ${scrolled || !hasHero ? "bg-white/80 backdrop-blur-md shadow-sm" : "bg-transparent"
      ...
      <div
        ...
        className={`md:hidden fixed inset-0 bg-black/50 z-50 transition-opacity duration-300 ${open ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
      ...
      <div
        ...
        className={`md:hidden fixed top-0 right-0 h-full w-72 bg-white z-[60]  flex flex-col transition-transform duration-500 ease-in-out ${open ? "translate-x-0" : "translate-x-full"
