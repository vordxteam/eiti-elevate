...
const PageHero = ({ heading, description, buttonLabel, buttonLink, backgroundImage }: PageHeroProps) => { 
  ...
  >
    ...
    <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 text-center py-20 sm:py-40">
      <h1
        ...
        style={{
          color: "white",
          textShadow: "0 2px 20px rgba(0,0,0,0.3), 0 0 40px rgba(28,166,163,0.2)",
        }}
      >
        {heading}
      </h1>
