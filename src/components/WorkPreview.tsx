...
const projects: Project[] = [
  {
    ...
    imageAlt: "Students collaborating on laptops in a bright workspace",
  },
  {
    id: 2,
    ...
    imageAlt: "Student presenting a project on a large screen to teammates",
  },
  {
    id: 3,
    ...
    imageAlt: "Group of diverse students working together at a table",
  },
  {
    id: 4,
    ...
    imageAlt: "Student coding on a laptop with mentor looking on",
  },
];
    ...
    <section className="relative bg-white py-20 px-4 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto mx-auto px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          <Link
            to="/work"
            className="group inline-flex items-center gap-3 px-8 py-4 rounded-full text-white font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-xl bg-[#1CA6A3] hover:bg-gradient-to-br from-[#1CA6A3] to-[#74B4E0]"
          >
